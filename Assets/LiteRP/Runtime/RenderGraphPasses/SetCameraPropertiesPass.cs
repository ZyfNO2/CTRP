...
namespace LiteRP
{
    ...
    {
        private static readonly ProfilingSampler s_SetupCameraPropertiesProfilingSampler = new ProfilingSampler(name: "Setup Camera Properties");
        ...
        {
            using (var builder = renderGraph.AddRasterRenderPass<SetupCameraPropertiesPassData>(passName: "SetupCameraProperties", 
